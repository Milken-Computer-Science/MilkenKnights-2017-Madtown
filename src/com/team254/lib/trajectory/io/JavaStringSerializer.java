...
/**
 * Save to a Java class with a static string, because J2ME has problems with large arrays.
 *
 * @author Jared341
 */
public class JavaStringSerializer implements IPathSerializer {

    @Override public String serialize(Path path) {
        ...
        contents +=
            "  private static final String kSerialized = \"" + tokenizer.nextToken() + "\\n\"\n";
