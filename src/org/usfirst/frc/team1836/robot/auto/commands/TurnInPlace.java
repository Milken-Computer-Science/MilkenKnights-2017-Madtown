...
public class TurnInPlace extends Command {
  ...
  protected void initialize() {
    org.usfirst.frc.team1836.robot.subsystems.Drive.getInstance()
        .setDriveTrajectory(m.genTraj(deg, Constants.DRIVE.DELTA_T, Constants.DRIVE.M_ACCEL,
            Constants.DRIVE.M_VEL, Constants.DRIVE.M_JERK), deg);
  }
  ...
  protected boolean isFinished() {
    return org.usfirst.frc.team1836.robot.subsystems.Drive.getInstance().getTrajectoryFinished();
  }
